build:
	...
	@gcc -o compiler main.c build/parser.tab.c build/lex.yy.c build/tree.o build/symboltable.o build/node.o build/symbolList.o build/typeChecker.o build/quadruple.o build/quadrupleLinkedList.o build/threeAddressGenerator.o
